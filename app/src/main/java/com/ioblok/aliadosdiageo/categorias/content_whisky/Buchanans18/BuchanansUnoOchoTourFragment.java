package com.ioblok.aliadosdiageo.categorias.content_whisky.Buchanans18;
...
public class BuchanansUnoOchoTourFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_buchanans_uno_ocho_tour, null);
    ...
    public void showPopup(View view, int numberPopup) {
        ...
        switch (numberPopup) {
            case 1:
                popupView = layoutInflater.inflate(R.layout.popup_uno_bcdieciocho, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
                text_popup = getString(R.string.txt_pop_up_uno_bcd);
                break;
            case 2:
                popupView = layoutInflater.inflate(R.layout.popup_dos_bcdieciocho, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.dos);
                text_popup = getString(R.string.txt_pop_up_dos_bcd);
                break;
            case 3:
                popupView = layoutInflater.inflate(R.layout.popup_tres_bcdieciocho, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.tres);
                text_popup = getString(R.string.txt_pop_up_tres_bcd);
                break;
            default:
                popupView = layoutInflater.inflate(R.layout.popup_uno_bcdieciocho, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
    ...
    public void onPause(){
        ...
        btnOpenPopup.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                View popupView = layoutInflater.inflate(R.layout.popup_uno_bcdieciocho, null);


                text_pop_uno = getString(R.string.txt_pop_up_uno_bcd);
        ...
        btnOpenPopupDos.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                LayoutInflater layoutInflater
                        = (LayoutInflater) getActivity().getBaseContext()
                        .getSystemService(getActivity().LAYOUT_INFLATER_SERVICE);
                View popupView = layoutInflater.inflate(R.layout.popup_dos_bcdieciocho, null);

                text_pop_dos = getString(R.string.txt_pop_up_dos_bcd);
        ...
        btnOpenPopupTres.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                LayoutInflater layoutInflater
                        = (LayoutInflater)getActivity().getBaseContext()
                        .getSystemService(getActivity().LAYOUT_INFLATER_SERVICE);
                View popupView = layoutInflater.inflate(R.layout.popup_tres_bcdieciocho, null);

                text_pop_tres = getString(R.string.txt_pop_up_tres_bcd);
