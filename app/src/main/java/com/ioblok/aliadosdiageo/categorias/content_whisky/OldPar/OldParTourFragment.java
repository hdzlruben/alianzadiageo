...
public class OldParTourFragment extends Fragment {
    ...
    public void showPopup(View view, int numberPopup) {
        ...
        switch (numberPopup) {
            case 1:
                popupView = layoutInflater.inflate(R.layout.popup_uno_op, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
                text_popup = getString(R.string.txt_pop_up_uno_op);
                break;
            case 2:
                popupView = layoutInflater.inflate(R.layout.popup_dos_op, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.dos);
                text_popup = getString(R.string.txt_pop_up_dos_op);
                break;
            case 3:
                popupView = layoutInflater.inflate(R.layout.popup_tres_op, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.tres);
                text_popup = getString(R.string.txt_pop_up_tres_op);
                break;
            case 4:
                popupView = layoutInflater.inflate(R.layout.popup_cuatro_op, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cuatro);
                text_popup = getString(R.string.txt_pop_up_cuatro_op);
                break;
            default:
                popupView = layoutInflater.inflate(R.layout.popup_uno_op, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
