...
public class JwRedLabelTourFragment extends Fragment {
    ...
    public void showPopup(View view, int numberPopup) {
        ...
        switch (numberPopup) {
            case 1:
                popupView = layoutInflater.inflate(R.layout.popup_uno_redl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
                text_popup = getString(R.string.txt_pop_up_uno_redl);
                break;
            case 2:
                popupView = layoutInflater.inflate(R.layout.popup_dos_redl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.dos);
                text_popup = getString(R.string.txt_pop_up_dos_redl);
                break;
            case 3:
                popupView = layoutInflater.inflate(R.layout.popup_tres_redl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.tres);
                text_popup = getString(R.string.txt_pop_up_tres_redl);
                break;
            case 4:
                popupView = layoutInflater.inflate(R.layout.popup_cuatro_redl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cuatro);
                text_popup = getString(R.string.txt_pop_up_cuatro_redl);
                break;
            case 5:
                popupView = layoutInflater.inflate(R.layout.popup_cinco_redl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cinco);
                text_popup = getString(R.string.txt_pop_up_cinco_redl);
                break;
            case 6:
                popupView = layoutInflater.inflate(R.layout.popup_seis_redl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.seis);
                text_popup = getString(R.string.txt_pop_up_seis_redl);
                break;
            default:
                popupView = layoutInflater.inflate(R.layout.popup_uno_redl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
