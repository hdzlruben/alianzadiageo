package com.ioblok.aliadosdiageo.categorias.content_whisky.OldParSilver;
...
public class OldParSilverTourFragment extends Fragment {
    ...
    public void showPopup(View view, int numberPopup) {
        ...
        switch (numberPopup) {
            case 1:
                popupView = layoutInflater.inflate(R.layout.popup_uno_ops, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
                text_popup = getString(R.string.txt_pop_up_uno_ops);
                break;
            case 2:
                popupView = layoutInflater.inflate(R.layout.popup_dos_ops, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.dos);
                text_popup = getString(R.string.txt_pop_up_dos_ops);
                break;
            case 3:
                popupView = layoutInflater.inflate(R.layout.popup_tres_ops, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.tres);
                text_popup = getString(R.string.txt_pop_up_tres_ops);
                break;
            case 4:
                popupView = layoutInflater.inflate(R.layout.popup_cuatro_ops, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cuatro);
                text_popup = getString(R.string.txt_pop_up_cuatro_ops);
                break;
            default:
                popupView = layoutInflater.inflate(R.layout.popup_uno_ops, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
...
/*
        ...
        btnOpenPopup.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                text_pop_uno = getString(R.string.txt_pop_up_uno_ops);
        ...
        btnOpenPopupDos.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                text_pop_dos = getString(R.string.txt_pop_up_dos_ops);
        ...
        btnOpenPopupTres.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                text_pop_tres = getString(R.string.txt_pop_up_tres_ops);
        ...
        btnOpenPopupCuatro.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                text_pop_cuatro = getString(R.string.txt_pop_up_cuatro_ops);
