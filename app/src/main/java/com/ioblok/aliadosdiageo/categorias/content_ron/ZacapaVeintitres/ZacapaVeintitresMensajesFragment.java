...
public class ZacapaVeintitresMensajesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_zacapa_veintitres_mensajes, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text = getString(R.string.txt_mensaje_baileys_dulce_uno);
        textdos = getString(R.string.txt_mensaje_baileys_dulce_dos);
        texttres = getString(R.string.txt_mensaje_baileys_dulce_tres);

        title_zacapa_23_uno = getString(R.string.title_zacapa_23_one);
        title_zacapa_23_dos = getString(R.string.title_zacapa_23_dos);
        title_zacapa_23_tres = getString(R.string.title_zacapa_23_tres);
