...
public class JwBlackLabelMensajesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_jw_black_label_mensajes, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text = getString(R.string.title_jw_black_label_one);
        textdos = getString(R.string.title_jw_black_label_dos);
        texttres = getString(R.string.title_jw_black_label_tres);
