...
public class OldParSilverServirFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_old_par_silver_servir, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        txt_como_tomar_jw_red_label_cuatro =  getString(R.string.txt_como_tomar_old_par_silver);
