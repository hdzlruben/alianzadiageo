...
public class BulletTourFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_bullet_tour, null);
    ...
    public void showPopup(View view, int numberPopup) {
        ...
        switch (numberPopup) {
            case 1:
                popupView = layoutInflater.inflate(R.layout.popup_uno_bulleit, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
                text_popup = getString(R.string.txt_pop_up_uno_bulleit);
                break;
            case 2:
                popupView = layoutInflater.inflate(R.layout.popup_dos_bulleit, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.dos);
                text_popup = getString(R.string.txt_pop_up_dos_bulleit);
                break;
            case 3:
                popupView = layoutInflater.inflate(R.layout.popup_tres_bullet, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.tres);
                text_popup = getString(R.string.txt_pop_up_tres_bulleit);
                break;
            case 4:
                popupView = layoutInflater.inflate(R.layout.popup_cuatro_bullet, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cuatro);
                text_popup = getString(R.string.txt_pop_up_cuatro_bulleit);
                break;
            default:
                popupView = layoutInflater.inflate(R.layout.popup_uno_bulleit, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
    ...
    public void onPause(){
        ...
        btnOpenPopup.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                View popupView = layoutInflater.inflate(R.layout.popup_uno_bulleit, null);

                text_pop_uno = getString(R.string.txt_pop_up_uno_bulleit);
        ...
        btnOpenPopupDos.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                LayoutInflater layoutInflater
                        = (LayoutInflater) getActivity().getBaseContext()
                        .getSystemService(getActivity().LAYOUT_INFLATER_SERVICE);
                View popupView = layoutInflater.inflate(R.layout.popup_dos_bulleit, null);

                text_pop_dos = getString(R.string.txt_pop_up_dos_bulleit);
        ...
        btnOpenPopupTres.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                LayoutInflater layoutInflater
                        = (LayoutInflater)getActivity().getBaseContext()
                        .getSystemService(getActivity().LAYOUT_INFLATER_SERVICE);
                View popupView = layoutInflater.inflate(R.layout.popup_tres_bullet, null);

                text_pop_tres = getString(R.string.txt_pop_up_tres_bulleit);
        ...
        btnOpenPopupCuatro.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                LayoutInflater layoutInflater
                        = (LayoutInflater)getActivity().getBaseContext()
                        .getSystemService(getActivity().LAYOUT_INFLATER_SERVICE);
                View popupView = layoutInflater.inflate(R.layout.popup_cuatro_bullet, null);

                text_pop_cuatro = getString(R.string.txt_pop_up_cuatro_bulleit);
