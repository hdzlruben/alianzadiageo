...
public class DonJulioRealServirFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_don_julio_real_servir, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text_content_subtitle =  getString(R.string.como_tomar_don_julio_real);
