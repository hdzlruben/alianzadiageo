...
public class JwBlackLabelTourFragment extends Fragment {
    ...
    public void showPopup(View view, int numberPopup) {
        ...
        switch (numberPopup) {
            case 1:
                popupView = layoutInflater.inflate(R.layout.popup_uno_jwbl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
                text_popup = getString(R.string.txt_pop_up_uno_jwbl);
                break;
            case 2:
                popupView = layoutInflater.inflate(R.layout.popup_dos_jwbl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.dos);
                text_popup = getString(R.string.txt_pop_up_dos_jwbl);
                break;
            case 3:
                popupView = layoutInflater.inflate(R.layout.popup_tres_jwbl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.tres);
                text_popup = getString(R.string.txt_pop_up_tres_jwbl);
                break;
            case 4:
                popupView = layoutInflater.inflate(R.layout.popup_cuatro_jwbl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cuatro);
                text_popup = getString(R.string.txt_pop_up_cuatro_jwbl);
                break;
            case 5:
                popupView = layoutInflater.inflate(R.layout.popup_cinco_jwbl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cinco);
                text_popup = getString(R.string.txt_pop_up_cinco_jwbl);
                break;
            default:
                popupView = layoutInflater.inflate(R.layout.popup_uno_jwbl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
    ...
    public void onPause(){
        ...
        btnOpenPopup.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                text_pop_uno = getString(R.string.txt_pop_up_uno_jwbl);
        ...
        btnOpenPopupDos.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                text_pop_dos = getString(R.string.txt_pop_up_dos_jwbl);
        ...
        btnOpenPopupTres.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                text_pop_tres = getString(R.string.txt_pop_up_tres_jwbl);
        ...
        btnOpenPopupCuatro.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                text_pop_cuatro = getString(R.string.txt_pop_up_cuatro_jwbl);
        ...
        btnOpenPopupCinco.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                text_pop_cinco = getString(R.string.txt_pop_up_cinco_jwbl);
