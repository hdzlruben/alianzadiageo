...
public class JwDoubleBlackLabelServirFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_jw_double_black_label_servir, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text_content_drink =  getString(R.string.txt_como_tomar_jw_double_black_label);
