...
public class OldParSilverMensajesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_old_par_silver_mensajes, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text = getString(R.string.title_old_par_silver_one);
        textdos = getString(R.string.title_old_par_silver_dos);
        texttres = getString(R.string.title_old_par_silver_tres);
