...
public class KetelOneTourFragment extends Fragment {
    ...
    public void showPopup(View view, int numberPopup) {
        ...
        switch (numberPopup) {
            case 1:
                popupView = layoutInflater.inflate(R.layout.popup_uno_ko, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
                text_popup = getString(R.string.txt_pop_up_uno_kt);
                break;
            case 2:
                popupView = layoutInflater.inflate(R.layout.popup_dos_ko, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.dos);
                text_popup = getString(R.string.txt_pop_up_dos_kt);
                break;
            case 3:
                popupView = layoutInflater.inflate(R.layout.popup_tres_ko, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.tres);
                text_popup = getString(R.string.txt_pop_up_tres_kt);
                break;
            case 4:
                popupView = layoutInflater.inflate(R.layout.popup_cuatro_ko, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cuatro);
                text_popup = getString(R.string.txt_pop_up_cuatro_kt);
                break;
            case 5:
                popupView = layoutInflater.inflate(R.layout.popup_cinco_ko, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cinco);
                text_popup = getString(R.string.txt_pop_up_cinco_kt);
                break;
            case 6:
                popupView = layoutInflater.inflate(R.layout.popup_seis_ko, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.seis);
                text_popup = getString(R.string.txt_pop_up_seis_kt);
                break;
            case 7:
                popupView = layoutInflater.inflate(R.layout.popup_siete_ko, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.siete);
                text_popup = getString(R.string.txt_pop_up_siete_kt);
                break;
            default:
                popupView = layoutInflater.inflate(R.layout.popup_uno_ko, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
