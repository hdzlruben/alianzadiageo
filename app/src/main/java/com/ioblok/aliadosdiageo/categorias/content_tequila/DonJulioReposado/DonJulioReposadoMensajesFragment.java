...
public class DonJulioReposadoMensajesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_don_julio_reposado_mensajes, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text = getString(R.string.title_don_julio_reposado_content_uno);
        textdos = getString(R.string.title_don_julio_reposado_content_dos);
        texttres = getString(R.string.title_don_julio_reposado_content_tres);

        title_zacapa_23_uno = getString(R.string.title_don_julio_reposado_one);
        title_zacapa_23_dos = getString(R.string.title_don_julio_reposado_dos);
        title_zacapa_23_tres = getString(R.string.title_don_julio_reposado_tres);
