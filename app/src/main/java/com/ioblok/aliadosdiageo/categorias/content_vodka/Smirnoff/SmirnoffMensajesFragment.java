...
public class SmirnoffMensajesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_smirnoff_mensajes, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text = getString(R.string.txt_mensaje_Smirnoff_uno);
        textdos = getString(R.string.txt_mensaje_Smirnoff_dos);
        texttres = getString(R.string.txt_mensaje_Smirnoff_tres);

        title_uno_ciroc = getString(R.string.txt_title_Smirnoff_uno);
        title_dos_ciroc = getString(R.string.txt_title_Smirnoff_dos);
        title_tres_ciroc = getString(R.string.txt_title_Smirnoff_tres);
