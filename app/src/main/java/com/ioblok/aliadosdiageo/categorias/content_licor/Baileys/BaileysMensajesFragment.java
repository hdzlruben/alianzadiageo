...
public class BaileysMensajesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_baileys_mensajes, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text = getString(R.string.txt_mensaje_baileys_uno);
        textdos = getString(R.string.txt_mensaje_baileys_dos);
        texttres = getString(R.string.txt_mensaje_baileys_tres);
