...
public class JandBMensajesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_j_and_b_mensajes, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text = getString(R.string.title_j_and_b_one);
        textdos = getString(R.string.title_j_and_b_dos);
        texttres = getString(R.string.title_j_and_b_tres);
