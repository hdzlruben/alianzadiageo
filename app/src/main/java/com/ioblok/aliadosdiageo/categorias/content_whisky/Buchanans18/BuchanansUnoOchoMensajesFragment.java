...
public class BuchanansUnoOchoMensajesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_buchanans_uno_ocho_mensajes, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text = getString(R.string.title_buchanans_uno_ocho_content_uno);
        textdos = getString(R.string.title_buchanans_uno_ocho_content_dos);
        texttres = getString(R.string.title_buchanans_uno_ocho_content_tres);

        title_zacapa_23_uno = getString(R.string.title_buchanans_uno_ocho_one);
        title_zacapa_23_dos = getString(R.string.title_buchanans_uno_ocho_dos);
        title_zacapa_23_tres = getString(R.string.title_buchanans_uno_ocho_tres);
