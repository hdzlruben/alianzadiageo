...
public class CaptainMorganWhiteServirFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_captain_morgan_white_servir, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text_subtitle_seccion =  getString(R.string.text_subtitle_seccion_capitan_morgan_white);
        text_content_subtitle =  getString(R.string.text_content_subtitle_capitan_morgan_white);
        text_subtitle_seccion_dos =  getString(R.string.text_subtitle_seccion_dos_capitan_morgan_white);
        text_content_subtitle_dos =  getString(R.string.text_content_subtitle_dos_capitan_morgan_white);
