...
public class JwPlatiniumServirFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_jw_platinium_servir, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text_title_drink =  getString(R.string.txt_como_tomar_jw_platinium);
