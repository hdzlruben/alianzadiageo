...
public class TanquerayTenMensajesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_tanqueray_ten_mensajes, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text = getString(R.string.txt_mensaje_tanqueray_ten_uno);
        textdos = getString(R.string.txt_mensaje_tanqueray_ten_dos);
        texttres = getString(R.string.txt_mensaje_tanqueray_ten_tres);
