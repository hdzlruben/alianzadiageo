...
public class JwDoubleBlackLabelTourFragment extends Fragment {
    ...
    public void showPopup(View view, int numberPopup) {
        ...
        switch (numberPopup) {
            case 1:
                popupView = layoutInflater.inflate(R.layout.popup_uno_dbl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
                text_popup = getString(R.string.txt_pop_up_uno_dbl);
                break;
            case 2:
                popupView = layoutInflater.inflate(R.layout.popup_dos_dbl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.dos);
                text_popup = getString(R.string.txt_pop_up_dos_dbl);
                break;
            case 3:
                popupView = layoutInflater.inflate(R.layout.popup_tres_dbl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.tres);
                text_popup = getString(R.string.txt_pop_up_tres_dbl);
                break;
            case 4:
                popupView = layoutInflater.inflate(R.layout.popup_cuatro_dbl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cuatro);
                text_popup = getString(R.string.txt_pop_up_cuatro_dbl);
                break;
            default:
                popupView = layoutInflater.inflate(R.layout.popup_uno_dbl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
    ...
    public void onPause(){
        ...
        btnOpenPopupUno.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                text_pop_uno = getString(R.string.txt_pop_up_uno_dbl);
        ...
        btnOpenPopupDos.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                text_pop_dos = getString(R.string.txt_pop_up_dos_dbl);
        ...
        btnOpenPopupTres.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                text_pop_tres = getString(R.string.txt_pop_up_tres_dbl);
        ...
        btnOpenPopupCuatro.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                text_pop_cuatro = getString(R.string.txt_pop_up_cuatro_dbl);
