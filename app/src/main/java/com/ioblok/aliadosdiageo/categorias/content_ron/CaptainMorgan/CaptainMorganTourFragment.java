...
public class CaptainMorganTourFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_captain_morgan_tour, null);
    ...
    public void showPopup(View view, int numberPopup) {
        ...
        switch (numberPopup) {
            case 1:
                popupView = layoutInflater.inflate(R.layout.popup_uno_cmc, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
                text_popup = getString(R.string.txt_pop_up_uno_cmc);
                break;
            case 2:
                popupView = layoutInflater.inflate(R.layout.popup_dos_cmc, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.dos);
                text_popup = getString(R.string.txt_pop_up_dos_cmc);
                break;
            case 3:
                popupView = layoutInflater.inflate(R.layout.popup_tres_cmc, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.tres);
                text_popup = getString(R.string.txt_pop_up_tres_cmc);
                break;
            case 4:
                popupView = layoutInflater.inflate(R.layout.popup_cuatro_cmc, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cuatro);
                text_popup = getString(R.string.txt_pop_up_cuatro_cmc);
                break;
            default:
                popupView = layoutInflater.inflate(R.layout.popup_uno_cmc, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
        ...
        btnOpenPopup.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                View popupView = layoutInflater.inflate(R.layout.popup_uno_cmc, null);

                text_pop_uno = getString(R.string.txt_pop_up_uno_cmc);
        ...
        btnOpenPopupDos.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                LayoutInflater layoutInflater
                        = (LayoutInflater)getActivity().getBaseContext()
                        .getSystemService(getActivity().LAYOUT_INFLATER_SERVICE);
                View popupView = layoutInflater.inflate(R.layout.popup_dos_cmc, null);

                text_pop_dos = getString(R.string.txt_pop_up_dos_cmc);
        ...
        btnOpenPopupTres.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                LayoutInflater layoutInflater
                        = (LayoutInflater)getActivity().getBaseContext()
                        .getSystemService(getActivity().LAYOUT_INFLATER_SERVICE);
                View popupView = layoutInflater.inflate(R.layout.popup_tres_cmc, null);

                text_pop_tres = getString(R.string.txt_pop_up_tres_cmc);
        ...
        btnOpenPopupCuatro.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                LayoutInflater layoutInflater
                        = (LayoutInflater)getActivity().getBaseContext()
                        .getSystemService(getActivity().LAYOUT_INFLATER_SERVICE);
                View popupView = layoutInflater.inflate(R.layout.popup_cuatro_cmc, null);

                text_pop_cuatro = getString(R.string.txt_pop_up_cuatro_cmc);
