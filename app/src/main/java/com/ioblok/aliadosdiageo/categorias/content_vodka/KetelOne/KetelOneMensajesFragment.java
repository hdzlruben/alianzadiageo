...
public class KetelOneMensajesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_ketel_one_mensajes, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text = getString(R.string.txt_mensaje_ketel_uno);
        textdos = getString(R.string.txt_mensaje_ketel_dos);
        texttres = getString(R.string.txt_mensaje_ketel_tres);

        title_uno_ciroc = getString(R.string.txt_title_mensaje_ketel_uno);
        title_dos_ciroc = getString(R.string.txt_title_mensaje_ketel_dos);
        title_tres_ciroc = getString(R.string.txt_title_mensaje_ketel_tres);
