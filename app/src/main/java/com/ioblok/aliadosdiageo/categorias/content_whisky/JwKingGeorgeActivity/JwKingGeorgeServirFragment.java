...
public class JwKingGeorgeServirFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_jw_king_george_servir, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text_title_drink =  getString(R.string.txt_como_tomar_jw_king_george);
        ...
        documentViewone.getDocumentLayoutParams().setTextAlignment(TextAlignment.JUSTIFIED);
