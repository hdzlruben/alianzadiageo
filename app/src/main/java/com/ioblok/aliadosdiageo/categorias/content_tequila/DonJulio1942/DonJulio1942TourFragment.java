...
public class DonJulio1942TourFragment extends Fragment {
    ...
    public void showPopup(View view, int numberPopup) {
        ...
        switch (numberPopup) {
            case 1:
                popupView = layoutInflater.inflate(R.layout.popup_uno_djdiecinueve, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
                text_popup = getString(R.string.txt_pop_up_uno_dj_diecinueve);
                break;
            case 2:
                popupView = layoutInflater.inflate(R.layout.popup_dos_djdiecinueve, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.dos);
                text_popup = getString(R.string.txt_pop_up_dos_dj_diecinueve);
                break;
            case 3:
                popupView = layoutInflater.inflate(R.layout.popup_tres_djdiecinueve, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.tres);
                text_popup = getString(R.string.txt_pop_up_tres_dj_diecinueve);
                break;
            default:
                popupView = layoutInflater.inflate(R.layout.popup_uno_djdiecinueve, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
