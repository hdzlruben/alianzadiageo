...
public class BuchanansUnoOchoServirFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_buchanans_red_seal_servir, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text_content_subtitle =  getString(R.string.como_tomar_buchanans_uno_ocho);
