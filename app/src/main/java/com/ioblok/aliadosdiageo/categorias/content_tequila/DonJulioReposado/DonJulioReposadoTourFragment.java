...
public class DonJulioReposadoTourFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_don_julio_reposado_tour, null);
    ...
    public void showPopup(View view, int numberPopup) {
        ...
        switch (numberPopup) {
            case 1:
                popupView = layoutInflater.inflate(R.layout.popup_uno_dj_reposado, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
                text_popup = getString(R.string.txt_pop_up_uno_dj_reposado);
                break;
            case 2:
                popupView = layoutInflater.inflate(R.layout.popup_dos_dj_reposado, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.dos);
                text_popup = getString(R.string.txt_pop_up_dos_dj_reposado);
                break;
            case 3:
                popupView = layoutInflater.inflate(R.layout.popup_tres_dj_reposado, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.tres);
                text_popup = getString(R.string.txt_pop_up_tres_dj_reposado);
                break;
            default:
                popupView = layoutInflater.inflate(R.layout.popup_uno_dj_reposado, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
...
/*
        btnOpenPopup.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                View popupView = layoutInflater.inflate(R.layout.popup_uno_dj_reposado, null);

                text_pop_uno = getString(R.string.txt_pop_up_uno_dj_reposado);
        ...
        btnOpenPopupDos.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                LayoutInflater layoutInflater
                        = (LayoutInflater)getActivity().getBaseContext()
                        .getSystemService(getActivity().LAYOUT_INFLATER_SERVICE);
                View popupView = layoutInflater.inflate(R.layout.popup_dos_dj_reposado, null);

                text_pop_dos = getString(R.string.txt_pop_up_dos_dj_reposado);
        ...
        btnOpenPopupTres.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                LayoutInflater layoutInflater
                        = (LayoutInflater)getActivity().getBaseContext()
                        .getSystemService(getActivity().LAYOUT_INFLATER_SERVICE);
                View popupView = layoutInflater.inflate(R.layout.popup_tres_dj_reposado, null);

                text_pop_tres = getString(R.string.txt_pop_up_tres_dj_reposado);
