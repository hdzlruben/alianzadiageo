...
public class BaileysDulceServirFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_baileys_dulce_servir, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text_content_subtitle =  getString(R.string.parrafo_uno_como_servir_baileys_dulce);
