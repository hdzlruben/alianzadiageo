...
public class CirocTourFragment extends Fragment {
    ...
    public void showPopup(View view, int numberPopup) {
        ...
        switch (numberPopup) {
            case 1:
                popupView = layoutInflater.inflate(R.layout.popup_uno_ci, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
                text_popup = getString(R.string.txt_pop_up_uno_ci);
                break;
            case 2:
                popupView = layoutInflater.inflate(R.layout.popup_dos_ci, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.dos);
                text_popup = getString(R.string.txt_pop_up_dos_ci);
                break;
            case 3:
                popupView = layoutInflater.inflate(R.layout.popup_tres_ci, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.tres);
                text_popup = getString(R.string.txt_pop_up_tres_ci);
                break;
            case 4:
                popupView = layoutInflater.inflate(R.layout.popup_cuatro_ci, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cuatro);
                text_popup = getString(R.string.txt_pop_up_cuatro_ci);
                break;
            case 5:
                popupView = layoutInflater.inflate(R.layout.popup_cinco_ci, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cinco);
                text_popup = getString(R.string.txt_pop_up_cinco_ci);
                break;
            default:
                popupView = layoutInflater.inflate(R.layout.popup_uno_ci, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
