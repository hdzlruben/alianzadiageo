...
public class JwGoldLabelTourFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_jw_gold_label_tour, null);
    ...
    public void showPopup(View view, int numberPopup) {
        ...
        switch (numberPopup) {
            case 1:
                popupView = layoutInflater.inflate(R.layout.popup_uno_gl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
                text_popup = getString(R.string.txt_pop_up_uno_gl);
                break;
            case 2:
                popupView = layoutInflater.inflate(R.layout.popup_dos_gl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.dos);
                text_popup = getString(R.string.txt_pop_up_dos_gl);
                break;
            case 3:
                popupView = layoutInflater.inflate(R.layout.popup_tres_gl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.tres);
                text_popup = getString(R.string.txt_pop_up_tres_gl);
                break;
            case 4:
                popupView = layoutInflater.inflate(R.layout.popup_cuatro_gl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cuatro);
                text_popup = getString(R.string.txt_pop_up_cuatro_gl);
                break;
            case 5:
                popupView = layoutInflater.inflate(R.layout.popup_cinco_gl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.cinco);
                text_popup = getString(R.string.txt_pop_up_cinco_gl);
                break;
            case 6:
                popupView = layoutInflater.inflate(R.layout.popup_seis_gl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.seis);
                text_popup = getString(R.string.txt_pop_up_seis_gl);
                break;
            default:
                popupView = layoutInflater.inflate(R.layout.popup_uno_gl, null);
                textPopupDV = (DocumentView) popupView.findViewById(R.id.uno);
    ...
    public void onPause(){
        ...
        btnOpenPopup.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                text_pop_uno = getString(R.string.txt_pop_up_uno_gl);
        ...
        btnOpenPopupDos.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                text_pop_dos = getString(R.string.txt_pop_up_dos_gl);
        ...
        btnOpenPopupTres.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                text_pop_tres = getString(R.string.txt_pop_up_tres_gl);
        ...
        btnOpenPopupCuatro.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                text_pop_cuatro = getString(R.string.txt_pop_up_cuatro_gl);
        ...
        btnOpenPopupCinco.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                text_pop_cinco = getString(R.string.txt_pop_up_cinco_gl);
        ...
        btnOpenPopupSeis.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                text_pop_seis = getString(R.string.txt_pop_up_seis_gl);
