...
public class CaptainMorganMensajesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_captain_morgan_mensajes, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text = getString(R.string.txt_captain_morgan_uno);
        textdos = getString(R.string.txt_captain_morgan_dos);
        texttres = getString(R.string.txt_captain_morgan_tres);
