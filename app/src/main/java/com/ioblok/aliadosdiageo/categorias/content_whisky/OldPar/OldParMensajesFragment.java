...
public class OldParMensajesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_old_par_mensajes, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text = getString(R.string.title_old_par_one);
        textdos = getString(R.string.title_old_par_dos);
        texttres = getString(R.string.title_old_par_tres);
