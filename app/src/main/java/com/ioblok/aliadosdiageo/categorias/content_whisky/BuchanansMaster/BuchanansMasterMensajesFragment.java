...
public class BuchanansMasterMensajesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_buchanans_master_mensajes, null);
        initialize();
        return v;
    }
    ...
    public void initialize(){
        ...
        text = getString(R.string.title_buchanans_master_one);
        textdos = getString(R.string.title_buchanans_master_dos);
        texttres = getString(R.string.title_buchanans_master_tres);
